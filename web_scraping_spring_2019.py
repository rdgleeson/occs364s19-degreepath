...
def main():
    ...
    url = 'http://www2.oberlin.edu/registrar/class-schedules/2018-2019/FINAL%20SPRING%202019%202.12.18.rhtml.html'
    ...
    for p in soup.findAll('pre'):
        ...
        if(len(newL)==0):
            ...
            file = "class_schedules_spring_2019/" + headers[counter] + ".xlsx"
