...
def main():
    ...
    for p in soup.findAll('pre'):
        ...
        if(count == 25 or count == 37 or count ==40 or count ==46 or count ==51):
            counter+=1
        ...
        if(len(newL)==0):
            ...
            if(count==12):
                file = "class_schedules_fall_2019/" + "COGNITIVE SCIENCE (COGS)" + ".xlsx"
                counter-=1
            else:    
                file = "class_schedules_fall_2019/" + headers[counter] + ".xlsx"
